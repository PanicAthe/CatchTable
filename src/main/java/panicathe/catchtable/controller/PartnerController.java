...
public class PartnerController {
    ...
    @Operation(summary = "상점 정보 수정", description = "소유한 특정 상점의 정보를 수정합니다.")
    ...
    @Operation(summary = "상점 삭제", description = "소유한 특정 상점을 삭제합니다.")
    ...
    @Operation(summary = "상점 리뷰 조회", description = "소유한 특정 상점의 리뷰를 조회합니다.")
    ...
    @Operation(summary = "상점 리뷰 삭제", description = "소유한 특정 상점의 리뷰를 삭제합니다.")
